<template>
                ...
                >
                    <div class="pb-0 px-2 w-full flex flex-col flex-wrap">
                        <ul class="space-y-1">
                            <li>
                                <a
                                    class="min-h-[36px] flex items-center gap-x-3.5 py-2 px-2.5 bg-gray-100 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:bg-neutral-700 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 dark:text-white"
                                    href="#"
                                >
                                    <svg
                                        class="size-4"
                            ...
                            <li>
                                <a
                                    class="min-h-[36px] w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 dark:text-neutral-200"
                                    href="#"
                                >
                                    <svg
                                        class="size-4"
    ...
    <template v-if="showBasicMenu">
        <ul>
            ...
            <li><NuxtLink to="/totp/">TOTP</NuxtLink></li>
            <li><NuxtLink to="/notes/">Notes</NuxtLink></li>
            <li><NuxtLink to="/notes/add">Add note</NuxtLink></li>
            <li><NuxtLink to="/notes/abc-123/edit">Edit 'abc-123'</NuxtLink></li>
        </ul>
    </template>
</template>

<script setup lang="ts">
const showBasicMenu = ref(!true);
</script>
